...
| OCR ML Kit | Reconnaissance de texte locale sur la photo d'etagere (Google ML Kit Text Recognition) |
...
| Point | Description |
|---|---|
| Edge Functions non deployees | Le scan utilise desormais ML Kit OCR + Google Books API (plus de fallback demo) |
