...
class AuthProvider extends ChangeNotifier {
  ...
  String? get userId => _testUserId ?? _firebaseUser?.uid;
  String? _testUserId;
  ...
  /// Force l'état authentifié pour les tests d'intégration (sans Firebase Auth)
  /// Annule le listener Firebase pour éviter que le stream écrase l'état test.
  void forceAuthenticatedForTest(String testUserId) {
